...
impl StitchJob {
    ...
    pub fn run(mut self, interrupted: &AtomicBool) -> Result<StitchResult, StitchError> {
        ...
        // Build session. Render params live on the calibration; an explicit
        // job override replaces the saved value, otherwise it renders as-is.
        ...
        cal.topology.blend_flip_direction = self.blend_flip_direction;
